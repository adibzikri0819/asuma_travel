<template>
  ...
  <div class="max-w-4xl mx-auto bg-white p-6 rounded-md space-y-6">
    ...
    <div>
      ...
      <h2 class="text-xl font-semibold mt-2">Maldives 4D3N</h2>
      <p class="text-sm text-gray-700 mt-2">
        Pakej percutian 4 hari 3 malam ke Maldives ini menawarkan pengalaman yang menakjubkan untuk pelancong Muslim. Anda akan menginap di resort yang mesra Muslim di Maafushi Island, menikmati makanan halal, dan terlibat dalam aktiviti menarik seperti snorkeling, melihat lumba-lumba, dan memancing pada waktu malam. Pakej ini termasuk pengangkutan dari dan ke lapangan terbang dengan speedboat, menjadikan perjalanan anda selesa dan menyeronokkan.
      </p>
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm text-gray-800">
      ...
      <div class="flex items-start gap-3">
        ...
        <div>
          ...
          <p>4 hari 3 malam. 3-Star hotel atau bersamaan</p>
        </div>
      </div>
    ...
    <div>
      ...
      <div class="overflow-hidden rounded-md mb-4">
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d13805.758741742647!2d73.5178475419842!3d3.202778353132242!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3b3c995f303a303f%3A0x38e16a29fd46a1bc!2sMaldives!5e0!3m2!1sen!2smy!4v1714292061502!5m2!1sen!2smy"
          width="100%"
          height="250"
          style="border:0;"
          allowfullscreen=""
      ...
      <div class="grid grid-cols-2 sm:grid-cols-4 gap-3 text-sm">
        <div class="bg-gray-100 rounded-md p-3 flex flex-col items-center text-center">
          ...
          <p class="text-gray-700">Panas</p>
        </div>
        <div class="bg-gray-100 rounded-md p-3 flex flex-col items-center text-center">
          <p class="font-medium">Suhu</p>
          <p class="text-gray-700">26°C – 32°C</p>
        </div>
        <div class="bg-gray-100 rounded-md p-3 flex flex-col items-center text-center">
          <p class="font-medium">Matawang</p>
          <p class="text-gray-700">Rufiah</p>
        </div>
        <div class="bg-gray-100 rounded-md p-3 flex flex-col items-center text-center">
          <p class="font-medium">4h 30m</p>
          <p class="text-gray-700">KUL → MLE</p>
        </div>
      </div>
    </div>
...
const attractions = [
  {
    title: 'Grand Friday Mosque',
    image: '/images/grand-friday-mosque.jpg',
    description: 'Majestic white marble mosque that can accommodate over 5,000 worshippers.'
  },
  {
    title: 'National Museum',
    image: '/images/national-museum-maldives.jpg',
    description: 'Showcases artifacts from the Sultanate era to present day, providing insights into Maldivian culture.'
  },
  {
    title: 'Artificial Beach',
    image: '/images/artificial-beach-maldives.jpg',
    description: 'Man-made beach offering a refreshing swim and local food at nearby eateries.'
  },
  {
    title: 'Tsunami Monument',
    image: '/images/umeda.jpg',
    description: 'Poignant reminder of lives lost in the 2004 Indian Ocean tsunami, symbolizing resilience.'
  },
  {
    title: 'Hukuru Miskiy',
    image: '/images/hukuru-miskiyy.jpg',
    description: 'One of the oldest mosques in Male, with intricate coral stone carvings and Arabic script.'
  },
  {
    title: 'Male Fish Market',
    image: '/images/male-fish-market.jpg',
    description: 'Experience the daily hustle and bustle as local fishermen bring in the freshest catch.'
  }
]
...
const itinerary = [
  {
    title: 'Day 1 - KL - MLE (Morning Arrival)',
    activities: [
      'Arrive at Velana International Airport, Male',
      'Boat transfer to hotel at Maafushi Island',
    ],
  },
  {
  ...
  },
  {
    ...
    activities: [
      'Free & easy on the beach',
    ],
  },
  {
    title: 'Day 4 - Checkout',
    activities: [
      'Check out',
      'Boat transfer to Velana International Airport',
    ],
  },
]
