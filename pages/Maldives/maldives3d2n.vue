<template>
  ...
  <div class="max-w-4xl mx-auto bg-white p-6 rounded-md space-y-6">
    ...
    <div>
      ...
      <h2 class="text-xl font-semibold mt-2">Maldives 3D2N</h2>
      <p class="text-sm text-gray-700 mt-2">
        Pakej percutian 3 hari 2 malam ke Maldives ini direka khas untuk pelancong Muslim, menawarkan pengalaman yang mewah dan santai. Anda akan menginap di resort eksklusif di pulau peribadi, menikmati makanan halal yang disediakan, serta aktiviti menarik seperti snorkeling, melihat lumba-lumba, dan mandi di pantai berpasir putih. Pakej ini termasuk penerbangan, pengangkutan persendirian, dan pemandu pelancong yang akan memastikan perjalanan anda selesa dan menyeronokkan.
      </p>
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm text-gray-800">
      ...
      <div class="flex items-start gap-3">
        ...
        <div>
          ...
          <p>3 hari 2 malam, 3-Star hotel atau bersamaan</p>
        </div>
      </div>
