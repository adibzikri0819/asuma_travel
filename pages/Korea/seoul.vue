<template>
  ...
  <div class="max-w-4xl mx-auto bg-white p-6 rounded-md space-y-6">
    ...
    <div>
      ...
      <h2 class="text-xl font-semibold mt-2">Seoul 6D4N</h2>
      <p class="text-sm text-gray-700 mt-2">
        Pakej perjalanan 6 hari 4 malam ke Seoul ini direka khas untuk pelancong Muslim, menawarkan pengalaman yang menarik dan selesa. Anda akan melawat tempat-tempat ikonik seperti Istana Gyeongbok, Nami Island, dan Lotte World, sambil menikmati makanan halal yang disediakan. Pakej ini termasuk penginapan di hotel mesra Muslim, pengangkutan persendirian, serta pemandu pelancong berpengalaman yang akan memastikan perjalanan anda selamat dan menyeronokkan.
      </p>
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm text-gray-800">
      ...
      <div class="flex items-start gap-3">
        ...
        <div>
          ...
          <p>6 hari 4 malam, 3-Star hotel atau berasrama</p>
        </div>
      </div>
    ...
    <div>
      ...
      <div class="overflow-hidden rounded-md mb-4">
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d126264.73838047976!2d126.84755913789208!3d37.566535!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x357ca31776b4d487%3A0x987f229b358fb95!2sSeoul%2C%20South%20Korea!5e0!3m2!1sen!2smy!4v1714292153481!5m2!1sen!2smy"
          width="100%"
          height="250"
          style="border:0;"
          allowfullscreen=""
      ...
      <div class="grid grid-cols-2 sm:grid-cols-4 gap-3 text-sm">
        <div class="bg-gray-100 rounded-md p-3 flex flex-col items-center text-center">
          ...
          <p class="text-gray-700">Sejuk</p>
        </div>
        <div class="bg-gray-100 rounded-md p-3 flex flex-col items-center text-center">
          <p class="font-medium">Suhu</p>
          <p class="text-gray-700">8°C – 19°C</p>
        </div>
        <div class="bg-gray-100 rounded-md p-3 flex flex-col items-center text-center">
          <p class="font-medium">Matawang</p>
          <p class="text-gray-700">Won</p>
        </div>
        <div class="bg-gray-100 rounded-md p-3 flex flex-col items-center text-center">
          <p class="font-medium">7h</p>
          <p class="text-gray-700">KUL → KOR</p>
        </div>
      </div>
    </div>
...
const attractions = [
  {
    ...
    image: '/images/gyeongbokgung-palace.jpg',
    description: "The grandest of Seoul's five palaces, showcasing beautiful architecture and rich history."
  },
  {
    title: 'N Seoul Tower',
    image: '/images/n-seoul-tower.jpg',
    description: 'Iconic tower offering panoramic views of the city, especially stunning at night.'
  },
  {
    title: 'Bukchon Hanok Village',
    image: '/images/bukchon-hanok.jpg',
    description: 'Traditional Korean village with beautifully preserved hanok houses and cultural experiences.'
  },
  {
    title: 'Myeongdong Shopping Street',
    image: '/images/myeongdong-shopping-street.jpg',
    description: 'Vibrant shopping district known for fashion, beauty products, and delicious street food.'
  },
  {
    title: 'Insadong Street',
    image: '/images/insadong-street.jpg',
    description: 'Cultural district filled with traditional crafts, tea houses, and art galleries.'
  },
  {
    title: 'War Memorial of Korea',
    image: '/images/war-memorial.jpg',
    description: "Comprehensive museum documenting Korea's military history and the Korean War."
  }
]
...
const itinerary = [
  {
    title: 'Day 1',
    activities: [
      'Kuala Lumpur to Incheon',
      'Flight to Incheon Airport, Seoul (arrive next day)',
    ],
  },
  {
    title: 'Day 2',
  ...
  },
  {
    title: 'Day 4',
    activities: [
      'Everland Theme Park (South Korea’s largest theme park)',
