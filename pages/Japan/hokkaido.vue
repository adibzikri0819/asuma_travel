<template>
  ...
  <div class="max-w-4xl mx-auto bg-white p-6 rounded-md space-y-6">
    ...
    <div>
      ...
      <h2 class="text-xl font-semibold mt-2">Hokkaido 5D4N</h2>
      <p class="text-sm text-gray-700 mt-2">
        Pakej perjalanan 5 hari 4 malam ke Hokkaido ini direka khas untuk pelancong Muslim, menawarkan pengalaman yang unik dan selesa. Anda akan melawat tempat-tempat menarik seperti Sapporo, Otaru, dan Noboribetsu, sambil menikmati makanan halal di restoran yang disahkan. Pakej ini termasuk penginapan di hotel mesra Muslim, pengangkutan persendirian, dan pemandu pelancong berpengalaman yang akan memastikan perjalanan anda berjalan lancar dan menyeronokkan.
      </p>
    </div>
    ...
    <div>
      ...
      <div class="overflow-hidden rounded-md mb-4">
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d324780.4973659885!2d141.0735517508315!3d43.06417!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x5f8c5acfb5b0b0ff%3A0x1109eaf95c6c45ae!2sHokkaido%2C%20Japan!5e0!3m2!1sen!2smy!4v1714291968790!5m2!1sen!2smy"
          width="100%"
          height="250"
          style="border:0;"
          allowfullscreen=""
      ...
      <div class="grid grid-cols-2 sm:grid-cols-4 gap-3 text-sm">
        ...
        <div class="bg-gray-100 rounded-md p-3 flex flex-col items-center text-center">
          <p class="font-medium">8h</p>
          <p class="text-gray-700">KUL → CTS</p>
        </div>
      </div>
    </div>
