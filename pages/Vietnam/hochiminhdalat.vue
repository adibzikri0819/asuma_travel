<template>
  ...
  <div class="max-w-4xl mx-auto bg-white p-6 rounded-md space-y-6">
    ...
    <div>
      ...
      <h2 class="text-xl font-semibold mt-2">Ho Chi Minh - Dalat - Muine 4D3N</h2>
      <p class="text-sm text-gray-700 mt-2">
        Pakej perjalanan 4 hari 3 malam dari Ho Chi Minh ke Dalat dan Mui Ne ini menawarkan pengalaman yang unik dan menarik untuk para pelancong Muslim. Dalam pakej ini, anda akan menikmati penginapan di hotel bertaraf 3 bintang, makanan halal sepanjang perjalanan, serta lawatan ke tempat-tempat menarik seperti Datanla Waterfall, White Sand Dunes, dan Mekong River.
      </p>
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm text-gray-800">
      <div class="flex items-start gap-3">
        ...
        <div>
          ...
          <p>Ho Chi Minh / Dalat / Mui Ne, Vietnam</p>
        </div>
      </div>
    ...
    <div>
      ...
      <div class="overflow-hidden rounded-md mb-4">
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3913.141010866159!2d108.4377075143155!3d11.940747492085431!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3174bdf01a347e2b%3A0x25b3fd8d92c5952d!2sDa%20Lat%2C%20Vietnam!5e0!3m2!1sen!2smy!4v1714292278911!5m2!1sen!2smy"
          width="100%"
          height="250"
          style="border:0;"
          allowfullscreen=""
      ...
      <div class="grid grid-cols-2 sm:grid-cols-4 gap-3 text-sm">
        ...
        <div class="bg-gray-100 rounded-md p-3 flex flex-col items-center text-center">
          ...
          <p class="text-gray-700">KUL → HCM</p>
        </div>
      </div>
    </div>
...
const attractions = [
  ...
  },
  {
    ...
    description: "Elegant French colonial-style palace in Da Lat, once used as a summer retreat by Vietnam's last emperor."
  },
  {
    title: 'Dalat Flower Gardens',
    image: '/images/flower-garden-dalat.jpg',
    description: 'Beautifully landscaped gardens in Da Lat featuring a wide variety of colorful flowers and plants.'
  },
  {
    title: 'Mui Ne Sand Dunes',
    image: '/images/muine-sand-dunes.jpg',
    description: 'Stunning red and white sand dunes in Mui Ne, perfect for sandboarding and exploring by quad bike.'
  },
  {
    title: 'Fairy Stream',
    image: '/images/Fairy Stream.jpg',
    description: 'Scenic stream in Mui Ne with colorful rock formations and shallow waters, ideal for a relaxing stroll.'
  }
]
...
const itinerary = [
  {
    title: 'Day 1',
    activities: [
      'Arrive at Tan Son Nhat (SGN) Airport',
      'Depart to Dalat (7 hours from Ho Chi Minh)',
    ],
  },
  {
    title: 'Day 2',
  ...
  },
  {
    title: 'Day 3',
    activities: [
      'Check out, depart to Muine (3 hours 30 mins from Dalat)',
      'Depart to Lang Chai (Fishing Village in Muine)',
    ],
  },
  {
    title: 'Day 4',
