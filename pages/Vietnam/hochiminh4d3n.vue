<template>
  ...
  <div class="max-w-4xl mx-auto bg-white p-6 rounded-md space-y-6">
    ...
    <div>
      ...
      <h2 class="text-xl font-semibold mt-2">Ho Chi Minh 4D3N</h2>
      <p class="text-sm text-gray-700 mt-2">
        Pakej perjalanan 4 hari 3 malam di Ho Chi Minh ini direka khas untuk pelancong Muslim, menawarkan pengalaman yang selesa dan menarik. Pakej ini termasuk penginapan di hotel mesra Muslim, makanan halal, dan lawatan ke lokasi menarik seperti Terowong Cu Chi dan Delta Mekong. Anda juga akan menikmati budaya tempatan dan membeli-belah di pasar terkenal. Dengan pemandu pelancong yang berpengalaman, perjalanan ini pasti akan memberikan kenangan yang tidak terlupakan.
      </p>
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm text-gray-800">
      ...
      <div class="flex items-start gap-3">
        ...
        <div>
          ...
          <p>4 hari 3 malam, 3-Star hotel atau berasrama</p>
        </div>
      </div>
    ...
    <div>
      ...
      <div class="overflow-hidden rounded-md mb-4">
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3918.765262442328!2d106.62965951431583!3d10.82309949229053!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31752d3035d156ff%3A0xfed17c27ff68c6f!2sHo%20Chi%20Minh%20City%2C%20Vietnam!5e0!3m2!1sen!2smy!4v1714292212971!5m2!1sen!2smy"
          width="100%"
          height="250"
          style="border:0;"
          allowfullscreen=""
      ...
      <div class="grid grid-cols-2 sm:grid-cols-4 gap-3 text-sm">
        ...
        <div class="bg-gray-100 rounded-md p-3 flex flex-col items-center text-center">
          ...
          <p class="text-gray-700">25°C – 35°C</p>
        </div>
        <div class="bg-gray-100 rounded-md p-3 flex flex-col items-center text-center">
          <p class="font-medium">Matawang</p>
          <p class="text-gray-700">Đồng</p>
        </div>
        <div class="bg-gray-100 rounded-md p-3 flex flex-col items-center text-center">
          <p class="font-medium">7h</p>
          <p class="text-gray-700">KUL → SGN</p>
        </div>
      </div>
    </div>
...
const attractions = [
  {
    ...
    image: '/images/war-remnants-museum.jpg',
    description: "Poignant museum showcasing Vietnam's struggle during the Vietnam War through exhibits and artifacts."
  },
  {
    title: 'Cu Chi Tunnels',
    image: '/images/cu-chi-tunnels.jpg',
    description: 'Vast underground tunnel network used by Viet Cong soldiers during the war, now a popular tourist attraction.'
  },
  {
    title: 'Notre Dame Cathedral',
    image: '/images/notre-dame.jpg',
    description: 'Iconic cathedral built with materials imported from France, featuring unique neo-Romanesque architecture.'
  },
  {
    title: 'Ben Thanh Market',
    image: '/images/ben-thanh-market.jpg',
    description: 'Bustling local market selling a wide variety of items from clothing to souvenirs and local products.'
  },
  {
    title: 'Reunification Palace',
    image: '/images/reunification-palace.jpg',
    description: 'Historic palace that served as the headquarters of the South Vietnamese government during the war.'
  },
  {
    title: 'Bitexco Financial Tower',
    image: '/images/bitexco-financial-tower.jpg',
    description: 'Tallest building in Ho Chi Minh City, offering panoramic views of the city from its observation deck.'
  }
]
...
const itinerary = [
  {
    title: 'Day 1',
    activities: [
      'Arrive in Ho Chi Minh Tan Son Nhat Airport',
      'Shopping around Ben Thant Market',
    ],
  },
  {
    title: 'Day 2',
    activities: [
      'Depart to Mekong River',
      'Cruise around 4 island',
    ],
  },
  {
    title: 'Day 3',
    activities: [
      'Depart to Cu Chi Tunnel',
      'Observe the war bunkers, ammunition garage and field hospitals',
    ],
  },
  {
